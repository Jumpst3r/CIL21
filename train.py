...
if __name__ == '__main__':
    ...
    model = StackedUNet(lr=1e-4, nb_blocks=6, share_weights=False, unet_mode='classic-backbone')
    trainer = pl.Trainer(max_epochs=150, gpus=1, stochastic_weight_avg=True, precision=16, deterministic=True,
