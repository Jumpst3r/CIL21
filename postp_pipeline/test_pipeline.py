...
def test(key, opts):
    ...
    infer_func, infer_opts = opts['infer']
    infer_path = infer_func(test_dataset, model, infer_opts)

    #pp_func, pp_opts = opts['pp']
    #pp_path = pp_func(infer_path, pp_opts)
