...
res152_path = r'models/unet/backbones/resnet152-394f9c45.pth'
...
class ResNetDUC(nn.Module):
    ...
    def __init__(self, n_channels, num_classes, pretrained=True):
        super(ResNetDUC, self).__init__()
        resnet = models.resnet152()
        if n_channels != 3:
            resnet.conv1 = nn.Conv2d(n_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
